...
@section('content')
<nav class="">
    <a href="{{route('apelacion.index')}}" class=" btn btn-primary m-3">Atras</a>
</nav>
...
<form action="{{route('reporte.exportApelacion')}}" method="POST">
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="checkbox" class="btn-check form-control col-sm-2" id="motivo" name="columns[Motivo]" value="motivo" checked>
        <label class="col-sm-4" for="motivo">Motivo</label>
        </div>
        <div class="row py-1">
    ...
    <div class="form-group">
        ...
        <input class="m-1" type="text" name="criteria[motivo]" placeholder="Motivo" class="form-control">
