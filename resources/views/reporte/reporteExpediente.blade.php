...
@section('content')
<nav class="">
    <a href="{{route('expediente.index')}}" class=" btn btn-primary m-3">Atras</a>
</nav>
...
<form action="{{route('reporte.exportExpediente')}}" method="POST">
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="checkbox" class="btn-check form-control col-sm-2" id="asunto" name="columns[Asunto]" value="asunto" checked>
        <label class="col-sm-4" for="asunto">Asunto</label>
        </div>
        <div class="row py-1">
    ...
    <div class="form-group">
        ...
        <input class="m-1" type="text" name="criteria[asunto]" placeholder="Asunto" class="form-control">
